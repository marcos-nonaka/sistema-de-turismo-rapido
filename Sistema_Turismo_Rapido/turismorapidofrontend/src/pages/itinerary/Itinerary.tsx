                            ...
                            <div className="tour-list">
                                <div className="row mb-4 border-bottom pb-5">
                                    ...
                                    <div className="col-md-8 col-sm-6 pt-3">
                                        {
                                            cidades?.map((cidade: { nome: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal | null | undefined; }) => {
                                                return (
                                                    <><h4 className="h4 fw-bold">{cidade.nome}<span>15 <i className="bi bi-hand-thumbs-up"></i> 0 <i className="bi bi-hand-thumbs-down"></i></span></h4><p>Ouro Preto é uma das primeiras cidades tombadas pelo Iphan, em 1938, e a primeira cidade brasileira a receber o título de Patrimônio Mundial, conferido pela Unesco, em 1980 [...]</p><p className="mb-1"><span className="btn btn-secondary rounded-5"><i className="bi bi-calendar3"></i> 2 dias</span> <span className="btn btn-secondary rounded-5"><i className="bi bi-cash-coin"></i> A partir de <strong>R$ 140,99</strong></span></p><p className="m-0">Coordenadas</p><p className="mb-3">@criador</p><a href="/roteiro" className="btn btn-warning btn-lg rounded-pill me-2 ps-4 pe-4">Ver roteiro</a></>
                                                )
                                            })
                                        }
                                    </div>
