            ...
            <div className="carousel-inner">
                <div className="carousel-item active">					
					...
					<div className="carousel-caption d-none d-md-block">
						<a href="pesquisar-roteiro.html" className="btn btn-warning btn-lg rounded-pill me-2 ps-4 pe-4">Explorar roteiros</a>
						<a href="pesquisar-roteiro.html" className="btn btn-custom-warning btn-lg rounded-pill me-2 ps-4 pe-4">Botão cor da paleta</a>		
					</div>					
                </div>
            </div>
