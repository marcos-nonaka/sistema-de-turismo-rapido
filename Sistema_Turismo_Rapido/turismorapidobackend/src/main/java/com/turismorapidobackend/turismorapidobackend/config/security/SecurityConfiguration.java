...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http
                ...
                .requestMatchers(HttpMethod.PUT, "/roteiros").hasAnyRole("ADMIN","TURISMOLOGO")
                .requestMatchers(HttpMethod.PUT, "/cidades").hasAnyRole("ADMIN","TURISMOLOGO")
                .requestMatchers(HttpMethod.PUT, "/hoteis").hasAnyRole("ADMIN","TURISMOLOGO")
                .requestMatchers(HttpMethod.PUT, "/atracoes").hasAnyRole("ADMIN","TURISMOLOGO")
                .requestMatchers(HttpMethod.PUT, "/alimentacao").hasAnyRole("ADMIN","TURISMOLOGO")
