...
public class HotelRequestDTO extends AbstractRequestDTO {
    ...
    @Size(min = 1, max = 100, message = "Nome tem tamanho mínimo de 1 e máximo de 100")
    ...
    @Size(min = 1, max = 100, message = "Rua tem tamanho mínimo de 1 e máximo de 100")
    String street_name;
    ...
    @Size(min = 1, max = 100, message = "Municipio tem tamanho mínimo de 1 e máximo de 100")
    String street_district;

    @NotBlank(message="Campo não pode ser vazio")
    @NotNull(message="Descrição precisa ser preenchido")
    @Size(min = 1, max = 1000, message = "Descrição tem tamanho mínimo de 1 e máximo de 1000")
